...
def sample_valid_sin_cos_base_sleep_data(mean_vec, cov_matrix, n_samples):
    ...
    while len(valid_rows) < n_samples and attempts < max_attempts:
        ...
        bed_sin, bed_cos = sample[2], sample[3]
        wake_sin, wake_cos = sample[4], sample[5]
...
def generate_synthetic_sleep_data(
    ...
    n_regular=1500,
    n_irregular=250,
    save_path_regular=r"C:\Users\kksy0316\source\repos\Alarm_project\csv\synthetic_selected_delete_1500.csv",
    save_path_irregular=r"C:\Users\kksy0316\source\repos\Alarm_project\csv\synthetic_irregular_selected_delete_250.csv",
    save_path_combined=r"C:\Users\kksy0316\source\repos\Alarm_project\csv\synthetic_combined_selected_delete_1750.csv",
    start_id=453
):
    df = pd.read_csv(source_csv)

    #수면 품질 관리 피처들
    sleep_features = ["Sleep_efficiency", "Awakenings"]
