...
# fire base 부분
# 서비스 키 받아오기
cred = credentials.Certificate(r"C:\Users\ksh\Desktop\Stop_Snoring-master\firebase\pasnallized-alarm-service-firebase-adminsdk-fbsvc-c001641e27.json")
# firebase 앱 초기화
...
ckpt_personal = torch.load(r"C:\Users\ksh\Desktop\Stop_Snoring-master\AI\weight_pt\personalized_model.pt", map_location=device)
